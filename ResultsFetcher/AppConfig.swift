...
//        try PersistanceStoreRegistry.register(CloudStorage(), coordinator: coordinator, cacheState: .NoCache)
        try PersistanceStoreRegistry.register(ParseStorage(), coordinator: coordinator, cacheState: .NoCache)
    }
}